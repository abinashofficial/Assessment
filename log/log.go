...
func doLog(cLog *log.Logger, level, callDepth int, v ...interface{}) {
	if level <= setLevel {
		...
		err := cLog.Output(callDepth, fmt.Sprintln(v...))
		if err != nil {
			return
		}
	}
...
/*
	CriticalError sends error to slack channel and  generates error log (following standard Tekion log spec)
	it uses slackUrl, env, slackChannel from environment variables
*/
//func CriticalError(ctx tapcontext.TContext, e error, data ...FieldsMap) {
//	var fields FieldsMap
//	if len(data) > 0 {
//		fields = data[0]
//	}
...
//		fieldsString := string(fieldsBytes)
//		errorLog(msg, "|", fieldsString)
//		slack.PublishErrorStatsToSlack(msg + "|" + fieldsString)
//	} else {
//		errorLog(msg)
//		slack.PublishErrorStatsToSlack(msg)
//	}
//}
